...
const Hospitals = () => {
  ...
  const hospitals = [
    ...
    },
    {
      ...
      email: 'neurology@korlebu.gh',
      services: ['Stroke Unit', 'CT Scan', 'Physiotherapy'],
    },
    {
      ...
      email: 'stroke@knh.or.ke',
      services: ['24/7 Emergency', 'Neurology', 'Rehabilitation Center'],
    },
    {
      name: 'Muhimbili National Hospital',
      city: 'Dar es Salaam',
      country: 'Tanzania',
      phone: '+255 22 215 1599',
      email: 'info@mnh.or.tz',
      services: ['Stroke Care', 'Imaging Services', 'Neurology'],
    },
    {
      name: 'Centre Hospitalier Universitaire de Fann',
      city: 'Dakar',
      country: 'Senegal',
      phone: '+221 33 869 1818',
      email: 'neurologie@fann.sn',
      services: ['Neurologie', 'Urgences', 'Rééducation'],
    },
    {
      ...
      services: ['Emergency Care', 'Neurology Department', 'Rehabilitation'],
    },
    {
      ...
      email: 'stroke@chbh.co.za',
      services: ['Stroke Unit', 'Advanced Imaging', 'Rehabilitation'],
    },
    {
      name: 'University Teaching Hospital',
      city: 'Lusaka',
      country: 'Zambia',
      phone: '+260 211 252 641',
      email: 'info@uth.gov.zm',
      services: ['Neurology', 'Emergency Services', 'Physiotherapy'],
    },
  ];
